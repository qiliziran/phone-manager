...
public class QQloginActivity extends AppCompatActivity {
    ...
    private static final String APP_ID = "1111089237";//官方获取的APPID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_qlogin);
        //传入参数APPID和全局Context上下文
        mTencent = Tencent.createInstance(APP_ID, QQloginActivity.this.getApplicationContext());
    }
